...
\begin{figure}[h!]
\includegraphics[scale = 1]{wishlist.jpg}
...
Po uruchomieniu programu zgodnie z punktem 2 niniejszej specyfikacji, w~przypadku poprawnego formatowania plików, działanie programu zakończy się, a w podfolderze \path{.\output} w folderze projektowym ukaże się nowy plik wynikowy \path{result.txt}.
